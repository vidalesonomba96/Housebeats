...
// Include notification handler for displaying messages
require_once 'src/components/notification_handler.php';
...
if (isset($_GET['ajax']) && $_GET['ajax'] === 'true') {
    ...
    // No includes for header, footer, main_content_start/end
} else {
    // For full page loads, include the standard HTML start
    // This should contain <html>, <head>, <body>, <header>, <main> opening tags
    include 'src/components/main_content_start.php';
    echo '<title>HouseBeats - Modern Beat Marketplace</title>';
    // Include header component (if main_content_start.php doesn't already, but it should in main_content_start)
    // require_once 'src/components/header.php'; // Likely not needed here if main_content_start includes it
}
        ...
        <section class="showcase-section">
            <div class="container showcase-container">
                <div class="showcase-text">
                    <p class="showcase-subtitle">#MADEONBHOUSEBEATS</p>
                    <h2 class="showcase-title">YES, THAT BEAT WAS BOUGHT ON HOUSEBEATS.</h2>
...
if (!isset($_GET['ajax']) || $_GET['ajax'] !== 'true') {
    ...
    // Include footer component (if main_content_end.php doesn't already)
    // require_once 'src/components/footer.php'; // Likely not needed here if main_content_end includes it
}
?>